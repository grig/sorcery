...
This is a fork of 0.7.x branch of sorcery intended for private use. For up to date code, please refer to the main
repository [https://github.com/noamB/sorcery].
